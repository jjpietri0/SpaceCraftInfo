...
import hr.jjpietri.rocketlaunchinfo.dao.Repository
import hr.jjpietri.rocketlaunchinfo.factory.getRocketLaunchRepository
import hr.jjpietri.rocketlaunchinfo.model.Item


private const val AUTHORITY = "hr.jjpietri.rocketlaunchinfo.api.provider"
private const val PATH = "items"
val ROCKET_LAUNCH_PROVIDER_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/$PATH")
...
class RocketLaunchContentProvider : ContentProvider() {
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        return ContentUris.withAppendedId(ROCKET_LAUNCH_PROVIDER_CONTENT_URI, id)
    }

    override fun onCreate(): Boolean {
        repository = getRocketLaunchRepository(context)
        return true
    }
